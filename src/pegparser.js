  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_code() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, v, m) {return '{"' + v + '":[' + m + "]}"})(pos0, result0[3], result0[6]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_declaration() {
        ...
        if (result0 !== null) {
          ...
          if (result2 !== null) {
            result2 = (function(offset, n) {return n})(pos4, result2[1]);
          }
          if (result2 === null) {
            pos = pos4;
          }
        ...
        if (result0 !== null) {
          result0 = (function(offset, x) {return x})(pos2, result0[1]);
        }
        if (result0 === null) {
          pos = pos2;
        }
        ...
        if (result0 !== null) {
          result0 = (function(offset, l, r) {return '{"' + "event" + '":' + '{"' + l.join("") + '"' + ":" + r + "}"+ '}' })(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_expvar() {
        ...
        result0 = parse_var();
        if (result0 !== null) {
          result0 = (function(offset, v) { return "this."  + v })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result4 !== null) {
                result4 = (function(offset, x) {return "," + x})(pos4, result4[1]);
              }
              if (result4 === null) {
                pos = pos4;
              }
              ...
              if (result3 !== null) {
                result3 = (function(offset, l, m) {return l.join(",") + m})(pos2, result3[0], result3[2]);
              }
              if (result3 === null) {
                pos = pos2;
              }
      ...
      function parse_svar() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, p) {return {args:(p.length>1?".":"") + p.slice(0, p.length-1).join("."), last:p[p.length-1], all: p.join(".")}})(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
